        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "nvarchar(255)", nullable: false, comment: "密码哈希值"),
                    Avatar = table.Column<string>(type: "nvarchar(255)", nullable: true, comment: "头像"),
                    DOB = table.Column<DateTime>(type: "date", nullable: true, comment: "出生日期"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "描述信息"),
                    Status = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<int>(nullable: false),
                    Type = table.Column<int>(nullable: false),
                    CreateTime = table.Column<DateTime>(nullable: false),
